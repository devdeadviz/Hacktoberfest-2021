...
def click(event, x, y, flags, params):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        # if(mbox.askyesno("Saving Permission", "Do you want to save snipped image?")):
        #     filename1 = filedialog.asksaveasfile(mode='w', defaultextension=".jpg")
        #     if not filename1:
        #         return
        #     sub_img.save(filename1)
